...
import net.levinh.android_carshowcase.Adapter.DetailsSlidePageAdapter;
...
public class CarDetailsActivity extends AppCompatActivity {
    ...
    int position;
    ViewPager viewPager;
    DetailsSlidePageAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        position =  getIntent().getBundleExtra(CarListActivity.BUNDLE)
                .getInt(CarListActivity.CAR_DATA);
        ...
        carDatastore.getCarList(new OnCarReceivedListener() {
            ...
            public void onCarReceived(List<Car> cars, Exception ex) {
                adapter = new DetailsSlidePageAdapter(getSupportFragmentManager(),cars);
                EndlessPagerAdapter endlessPagerAdapter = new EndlessPagerAdapter(adapter);
